...
public class ConsolaConversor implements InterfaceVista {
    ...
    private void solicitaOperacion(){
        ...
        System.out.println("[3] Convertir euros a pesos");
        System.out.println("[4] Convertir pesos a euros");
    ...
    private void procesaNuevaOperacion(){
        ...
        if(operacion == 3) control.actionPerformed(new ActionEvent(this, operacion, AEUROS));
        if(operacion == 4) control.actionPerformed(new ActionEvent(this, operacion, PESOSAEUROS));
        if(operacion == 5){
